...
const Shipments = () => {
  ...
  console.log("filteredShipments", filterPlainArray(shipments, filters));

  console.log("testFilters", filtersActive)
    ...
    <Container>
      <Row>
        ...
        <Col className="text-end">
          ...
          <div>
            <Button variant="primary text-white rounded-pill mt-2 mb-2">Filter</Button>
          </div>
        </Col>
      </Row>
      {!filtersActive
